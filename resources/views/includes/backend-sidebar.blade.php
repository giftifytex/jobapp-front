...
<div class="user-sidebar">
  ...
  <div class="sidebar-inner">
    <ul class="navigation">
      ...
      <li><a href="/company-profile"><i class="la la-user-tie"></i>Company Profile</a></li>
      <li><a href="new-job"><i class="la la-paper-plane"></i>Post a New Job</a></li>
      <li><a href="/manage-jobs"><i class="la la-briefcase"></i> Manage Jobs </a></li>
      <li><a href="applicants"><i class="la la-file-invoice"></i> All Applicants</a></li>
